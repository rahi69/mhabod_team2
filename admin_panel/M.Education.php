...
<!--                </a>-->
            ...
            <div id="myOverlayone" class="overlay">
                ...
                <div class="overlay-content">
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <?php
                        $function->add_cat(); ?>
                        <button type="submit" name="submit" id="mybtn" class="row col-lg-12 btn btn-primary btn-lg">
                            افزودن دسته
                        </button>
                        <!--                        <button id="mybtn" type="submit" name="submit"  class="row col-lg-12 btn btn-primary btn-lg" >افزودن دسته</button>-->

                        <br/><br/><br/><br/>
                        <input class="row col-lg-12" name="name_cat" type="text" onclick="off()" placeholder="نام دسته">
                    </form>
                </div>
            </div>
            <div id="myOverlaytow" class="overlay" onclick="closeSearch2()">
                ...
                <div class="overlay-content">
                    <div class="containerrrrr" onclick="off()">
                        <form enctype="multipart/form-data"
                            ...
                            <br/>
                            <div class="form-group">
                                <button style="margin-left:600px;" class="btn btn-danger" type="submit" name="Add">ثبت
                                </button>
                            </div>
                            <?php
                            $function->add_video();
